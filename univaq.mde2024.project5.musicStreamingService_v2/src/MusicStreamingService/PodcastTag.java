...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Podcast Tag</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see MusicStreamingService.MusicStreamingServicePackage#getPodcastTag()
 * @model
 * @generated
 */
public enum PodcastTag implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Podcast Tag</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final PodcastTag[] VALUES_ARRAY =
		new PodcastTag[] {
			FILM,
			LIFESTYLE,
			EDUCATION,
	...
	/**
	 * A public read-only list of all the '<em><b>Podcast Tag</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<PodcastTag> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Podcast Tag</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static PodcastTag get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			PodcastTag result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Podcast Tag</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static PodcastTag getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			PodcastTag result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Podcast Tag</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static PodcastTag get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private PodcastTag(int value, String name, String literal) {
		this.value = value;
		this.name = name;
